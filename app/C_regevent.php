...
$sql="insert into coordinators_data(student_name,student_regno,department,email,gender,event_name,phone_number,year) values('$fullname','$regno','$department','$email','$gender','$eventname','$phoneno','$year')";
